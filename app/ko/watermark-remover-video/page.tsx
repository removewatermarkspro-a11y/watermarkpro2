...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://removewatermarkpro.co/ko/watermark-remover-video',
        languages: {
    ...
    openGraph: {
        ...
        url: 'https://removewatermarkpro.co/ko/watermark-remover-video',
        siteName: 'Remove Watermark Pro',
        locale: 'ko_KR',
        type: 'website',
        images: [
            {
                url: 'https://removewatermarkpro.co/og-image-video-ko.jpg',
                width: 1200,
                height: 630,
    ...
    twitter: {
        ...
        title: '무료 비디오 워터마크 제거 | AI 비디오 워터마크 제거 도구',
        description: '클릭 한 번으로 비디오에서 워터마크를 제거하세요. MP4, MOV, AVI용 무료 AI 도구. 빠르고 가입 불필요.',
        images: ['https://removewatermarkpro.co/og-image-video-ko.jpg']
    },
