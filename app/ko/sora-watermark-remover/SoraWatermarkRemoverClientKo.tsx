...
export default function SoraWatermarkRemoverClientKo() {
    ...
    const faqItems = language === 'ko' ? soraRemoverFaqItemsKo : language === 'fr' ? soraRemoverFaqItemsFr : language === 'es' ? soraRemoverFaqItemsEs : language === 'de' ? soraRemoverFaqItemsDe : language === 'pt' ? soraRemoverFaqItemsPt : language === 'no' ? soraRemoverFaqItemsNo : soraRemoverFaqItems
