        ...
        <>
            ...
            <main className={styles.main}>
                <div className="container">
                    ...
                    <FAQ items={
                        language === 'fr' ? peopleRemovalFaqItemsFr :
                            language === 'de' ? removePeopleFaqItemsDe :
                                language === 'es' ? peopleRemovalFaqItemsEs :
                                    language === 'pt' ? peopleRemovalFaqItemsPt :
                                        language === 'ko' ? peopleRemovalFaqItemsKo :
                                            language === 'no' ? peopleRemovalFaqItemsNo :
