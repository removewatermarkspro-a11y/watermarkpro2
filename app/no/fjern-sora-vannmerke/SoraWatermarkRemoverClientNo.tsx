...
export default function SoraWatermarkRemoverClientNo() {
    ...
    const faqItems = language === 'no' ? soraRemoverFaqItemsNo : language === 'fr' ? soraRemoverFaqItemsFr : language === 'es' ? soraRemoverFaqItemsEs : language === 'de' ? soraRemoverFaqItemsDe : language === 'pt' ? soraRemoverFaqItemsPt : language === 'ko' ? soraRemoverFaqItemsKo : soraRemoverFaqItems
