        ...
        <>
            ...
            <main className={styles.main}>
                <div className="container">
                    ...
                    <FAQ items={
                        language === 'fr' ? textRemovalFaqItemsFr :
                            language === 'de' ? removeTextFaqItemsDe :
                                language === 'es' ? textRemovalFaqItemsEs :
                                    language === 'pt' ? textRemovalFaqItemsPt :
                                        language === 'ko' ? textRemovalFaqItemsKo :
                                            language === 'no' ? textRemovalFaqItemsNo :
                                                textRemovalFaqItems
                    } />
