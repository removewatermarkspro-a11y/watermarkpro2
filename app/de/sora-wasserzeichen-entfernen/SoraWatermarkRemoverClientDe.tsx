...
export default function SoraWatermarkRemoverClientDe() {
    ...
    const faqItems = language === 'de' ? soraRemoverFaqItemsDe : language === 'fr' ? soraRemoverFaqItemsFr : language === 'es' ? soraRemoverFaqItemsEs : language === 'pt' ? soraRemoverFaqItemsPt : language === 'ko' ? soraRemoverFaqItemsKo : language === 'no' ? soraRemoverFaqItemsNo : soraRemoverFaqItems
