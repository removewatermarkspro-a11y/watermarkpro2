...
export default function VideoWatermarkRemoverClientEs() {
                    ...
                    <section className={styles.hero}>
                        ...
                        <div ref={uploadRef} className={styles.uploadSection}>
                            <ImageUploader
                                ...
                                processingText={t.videoWatermarkPage.uploader.processingText || "Procesando tu video..."}
                    ...
                    <section className={styles.features}>
                        ...
                        <div className={styles.featureGrid}>
                            ...
                            <div className={styles.featureItem}>
                                <div className={styles.featureImage}>
<<<<<<< HEAD
                                    <img src="/images-optimized/remove-tiktok-watermark-video.webp" alt="Eliminar Marca de Agua TikTok" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '12px' }} loading="lazy" decoding="async" />
=======
                                    <img src="/images/features/video-page-tiktok-girls.png" alt="Eliminar Marca de Agua TikTok" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '12px' }} />
>>>>>>> feature/qwen-api-integration
                            ...
                            <div className={styles.featureItem}>
                                <div className={styles.featureImage}>
<<<<<<< HEAD
                                    <img src="/images-optimized/video-watermark-removal-example.webp" alt="Eliminación de Marca de Agua de Video" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '12px' }} loading="lazy" decoding="async" />
=======
                                    <img src="/images/features/video-page-red-panda.png" alt="Eliminación de Marca de Agua de Video" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '12px' }} />
>>>>>>> feature/qwen-api-integration
                                </div>
                                <div className={styles.featureContent}>
