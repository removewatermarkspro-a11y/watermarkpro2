...
export default function BackgroundRemoverClientEs() {
            ...
            <main className={styles.main}>
                <div className="container">
                    <section className={styles.hero}>
                        ...
                        <h1 className={`${styles.title} ${styles.orderTitle}`}>{t.removeBackgroundPage.hero.title} <span className={styles.violetText}>{t.removeBackgroundPage.hero.titleHighlight}</span></h1>
                    ...
                    <FAQ items={backgroundRemovalFaqItemsEs} />
