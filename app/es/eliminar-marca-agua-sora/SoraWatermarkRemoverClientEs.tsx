...
export default function SoraWatermarkRemoverClientEs() {
    ...
    const faqItems = language === 'es' ? soraRemoverFaqItemsEs : language === 'fr' ? soraRemoverFaqItemsFr : language === 'de' ? soraRemoverFaqItemsDe : language === 'pt' ? soraRemoverFaqItemsPt : language === 'ko' ? soraRemoverFaqItemsKo : language === 'no' ? soraRemoverFaqItemsNo : soraRemoverFaqItems
