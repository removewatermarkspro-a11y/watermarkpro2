...
export default function TextRemoverClientEs() {
...
<<<<<<< HEAD
                                    <img src="/images-optimized/delete-text-from-photo.webp" alt="Remove text" style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="lazy" decoding="async" />
=======
                                    <img src="/images/feature-remove-text-tablet.png" alt="Remove text" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
...
>>>>>>> feature/qwen-api-integration
                            ...
                            <div className={styles.featureItem}>
                                <div className={styles.featureImage} style={{ padding: 0, overflow: 'hidden' }}>
<<<<<<< HEAD
                                    <img src="/images-optimized/remove-text-from-image-ai.webp" alt="Complete solution" style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="lazy" decoding="async" />
=======
                                    <img src="/images/feature-remove-text-paint.png" alt="Complete solution" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
>>>>>>> feature/qwen-api-integration
                                </div>
                                <div className={styles.featureContent}>
                    ...
                    <FAQ items={textRemovalFaqItemsEs} />
<<<<<<< HEAD
