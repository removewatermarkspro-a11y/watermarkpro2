                ...
                <div className="container">
                    ...
                    <section className={styles.features}>
                        ...
                        <div className={styles.featureGrid}>
                            ...
                            <div className={styles.featureItem}>
                                <div className={styles.featureImage}>
                                    <img src="/images-optimized/remove-tiktok-watermark-video.webp" alt="Supprimer Filigrane TikTok" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '12px' }} loading="lazy" decoding="async" />
                                </div>
                                <div className={styles.featureContent}>
                            ...
                            <div className={styles.featureItem}>
                                <div className={styles.featureImage}>
                                    <img src="/images-optimized/video-watermark-removal-example.webp" alt="Suppression Filigrane Vidéo" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '12px' }} loading="lazy" decoding="async" />
                                </div>
                                <div className={styles.featureContent}>
