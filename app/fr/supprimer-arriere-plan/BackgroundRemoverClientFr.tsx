...
export default function BackgroundRemoverClientFr() {
                ...
                <div className="container">
                    <section className={styles.hero}>
                        ...
                        <h1 className={styles.title}>
                            {t.removeBackgroundPage.hero.title} <span className={styles.violetText}>{t.removeBackgroundPage.hero.titleHighlight}</span>
                        </h1>
                    ...
                    <FAQ items={backgroundRemovalFaqItemsFr} />
