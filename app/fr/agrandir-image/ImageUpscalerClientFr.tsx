...
export default function ImageUpscalerClientFr() {
                ...
                <div className="container">
                    <section className={styles.hero}>
                        ...
                        <h1 className={`${styles.title} ${styles.orderTitle}`}>
                            {t.imageUpscalerPage.hero.title} <span className={styles.violetText}>{t.imageUpscalerPage.hero.titleHighlight}</span>
                        </h1>
                    ...
                    <FAQ items={imageUpscalerFaqItemsFr} />
