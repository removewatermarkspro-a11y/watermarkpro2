...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://removewatermarkpro.co/fr/enlever-filigrane-sora',
        languages: {
    ...
    openGraph: {
        ...
        url: 'https://removewatermarkpro.co/fr/enlever-filigrane-sora',
        siteName: 'Remove Watermark Pro',
        locale: 'fr_FR',
        type: 'website',
        images: [
            {
                url: 'https://removewatermarkpro.co/og-image-sora-fr.jpg',
                width: 1200,
                height: 630,
    ...
    twitter: {
        ...
        title: 'Supprimer Filigrane Sora Gratuit | Enlever Logo OpenAI Sora',
        description: 'Supprimez les filigranes Sora AI instantanément. Outil gratuit pour effacer les logos, marques OpenAI Sora des vidéos IA.',
        images: ['https://removewatermarkpro.co/og-image-sora-fr.jpg']
    },
