...
export default function RemoveBackground() {
    ...
    const faqItems = [
        { question: "What is background removal used for?", answer: "Background removal is perfect for product photography, profile pictures, creating transparent PNGs, e-commerce listings, graphic design, and any project where you need a clean subject without distractions." },
        { question: "Will fine details like hair be preserved?", answer: "Yes! Our AI uses advanced algorithms to detect and preserve fine details including hair strands, fur, transparent objects, and complex edges for professional results." },
        { question: "Can I download with a transparent background?", answer: "Absolutely! You can download your image as a PNG with a transparent background, perfect for overlaying on other images or designs." },
        { question: "Does it work with complex images?", answer: "Yes! Our AI can handle complex scenes including multiple subjects, intricate details, and challenging backgrounds. The more contrast between subject and background, the better the results." },
        { question: "Can I add a new background after removal?", answer: "Yes! After removing the background, you can add a solid color, gradient, or upload your own custom background image." },
        { question: "What file formats are supported?", answer: "We support JPG, PNG, WEBP, and other common formats. You can export as PNG (with transparency) or JPG (with solid color background)." }
    ]
            ...
            <main className={styles.main}>
                <div className="container">
                    <section className={styles.hero}>
                        <SocialProof />
                        <h1 className={styles.title}>Remove <span className="gradient-text">background</span></h1>
                    ...
                    <section className={styles.features}>
                        <div style={{ textAlign: 'center' }}>
                            ...
                            <h2 className={styles.sectionTitle}>AI Background Removal – Precise & Professional</h2>
                        </div>
